create table slackjar_trick_two.sys_user
(
    ...
    create table slackjar_trick_two.role
(
...
create table slackjar_trick_two.user_role
(
...
create table slackjar_trick_two.permission
(
...
create table slackjar_trick_two.role_permission
(
    id            bigint auto_increment comment '关联记录ID'
        primary key,
    role_id       bigint            not null comment '角色ID（关联角色表主键）',
...
create table slackjar_trick_two.sys_file
(
...
create table slackjar_trick_two.ssl_certificate
(
...
create table slackjar_trick_two.sys_config
(
    id           bigint auto_increment comment '主键ID'
        primary key,
...
create table slackjar_trick_two.sys_dict
(
...
create table slackjar_trick_two.sys_dict_item
(
...
-- 用户设备登录记录表
create table slackjar_trick_two.user_device (
